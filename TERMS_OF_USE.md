...
Boson provides local-first tools for tracking business operations, including sales, expenses, inventory, clients, services, invoices, and portfolio reporting. Authenticated account and business records may synchronize automatically through Boson Cloud when a connection is available.

Boson is an evolving prerelease product. Features may change, be interrupted, contain errors, or be discontinued. You should maintain appropriate independent records and backups for your business.

## 4. No Accounting, Tax, Legal, or Financial Advice

Boson is an organizational tool and is not a certified accounting, tax-filing, legal, payroll, banking, or financial-advice service. Reports, calculations, exchange-rate conversions, invoices, and reminders may be incomplete or inaccurate and must be independently reviewed before you rely on them for business, tax, legal, or financial decisions.
...
Boson relies on third-party services, including Supabase for authentication and cloud data services, Frankfurter for exchange-rate information, and Apple for iOS distribution and TestFlight. Their availability and terms may affect Boson. We are not responsible for third-party services that we do not control.
...
Boson does not currently charge a subscription fee for this prerelease version. If paid features are introduced, pricing and any additional terms will be presented before you are charged. We may update the service or these Terms as Boson develops. The effective date identifies the current version.

## 9. Suspension, Termination, and Deletion

You may stop using Boson at any time and can permanently delete your account from Personal Settings. We may suspend or terminate access when reasonably necessary to protect Boson, users, third parties, or the public; respond to legal requirements; address nonpayment for future paid features; or enforce these Terms.
